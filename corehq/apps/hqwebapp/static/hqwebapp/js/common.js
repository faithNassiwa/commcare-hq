...
(function(d){"function"===typeof require&&"object"===typeof exports&&"object"===typeof module?d(require("knockout"),exports):"function"===typeof define&&define.amd?define('ko.mapping',["knockout","exports"],d):d(ko,ko.mapping={})})(function(d,f){function C(a,c){for(var b in c)c.hasOwnProperty(b)&&c[b]&&(b&&a[b]&&!(a[b]instanceof Array)?C(a[b],c[b]):a[b]=c[b])}function D(a,c){var b={};C(b,a);C(b,c);return b}function E(a,c){a=a||{};if(a.create instanceof Function||a.update instanceof Function||a.key instanceof Function||
...
*/
define('hqwebapp/js/django',[], function() {

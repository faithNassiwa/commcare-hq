...
define("accounting/js/credits_tab", [
    'jquery',
    'knockout',
], function(
    $,
...
define('accounting/js/billing_account_form', [
    'jquery',
    'knockout',
    'hqwebapp/js/initial_page_data',
...
define('accounting/js/base_subscriptions_main', [
    'jquery',
    'knockout',
    'accounting/js/widgets',
    'accounting/js/credits_tab',
...
define("accounting/js/enterprise_settings", [
    'jquery',
    'knockout',
    'underscore',
...
define("bootstrap-timepicker/js/bootstrap-timepicker", function(){});

define("hqwebapp/js/select2_handler", [
    "jquery",
    "knockout",
    "select2-3.5.2-legacy/select2",
...
define("accounting/js/software_plan_version_handler", [
    'jquery',
    'knockout',
    'underscore',
    'hqwebapp/js/initial_page_data',
...
define('accounting/js/subscriptions_main', [
    'jquery',
    'hqwebapp/js/initial_page_data',
    'accounting/js/widgets',
...
define("accounting/js/bundle", function(){});

define('domain/js/media_manager', [
    'jquery',
    'knockout',
...
define("domain/js/internal_calculations", [
    'jquery',
    'hqwebapp/js/initial_page_data',
], function(
    $,
...
(function( factory ) {
	if ( typeof define === "function" && define.amd ) {
		...
		define( 'jquery-ui/ui/core',[ "jquery" ], factory );
	} else {
...
(function( factory ) {
	if ( typeof define === "function" && define.amd ) {
		...
		// AMD. Register as an anonymous module.
		define('jquery-ui/ui/datepicker',[
			"jquery",
			"./core"
		], factory );
	} else {
...
define("domain/js/create_snapshot", [
    'jquery',
    'underscore',
    'hqwebapp/js/initial_page_data',
    'analytix/js/google',
...
define("select2-3.5.2-legacy/select2", function(){});

define('domain/js/pro-bono', [
    'jquery',
...
define("domain/js/commtrack_settings", ['jquery'], function(jquery) {
    $(function() {
...
define("domain/js/snapshot_settings", [
    'jquery',
    'underscore',
    'hqwebapp/js/initial_page_data',
    'analytix/js/google',
...
define("multiselect/js/jquery.multi-select", function(){});
...
define("domain/js/internal_settings", [
    'jquery',
    'knockout',
    'underscore',
    'hqwebapp/js/initial_page_data',
...
define("domain/js/my_project_settings", [
    'jquery',
    'knockout',
    'hqwebapp/js/initial_page_data',
], function(
...
(function( factory ) {
	if ( typeof define === "function" && define.amd ) {
		...
		// AMD. Register as an anonymous module.
		define( 'jquery-ui/ui/widget',[ "jquery" ], factory );
	} else {
...
/* global DOMPurify */
define("hqwebapp/js/knockout_bindings.ko", [
    'jquery',
    'knockout',
...
define('domain/js/case_search_main', [
    'jquery',
    'hqwebapp/js/initial_page_data',
...
define("domain/js/bundle", function(){});

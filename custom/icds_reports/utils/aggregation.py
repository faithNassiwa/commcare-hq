...
class ChildHealthMonthlyAggregationHelper(BaseICDSAggregationHelper):
    ...
    def aggregation_query(self):
        ...
        born_in_month = "(child_health.dob BETWEEN {} AND {})".format(start_month_string, end_month_string)
        ...
        columns = (
            ...
            ("born_in_month", "CASE WHEN {} AND {} THEN 1 ELSE 0 END".format(born_in_month, seeking_services)),
